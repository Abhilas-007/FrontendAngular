...
export class AdminService {
  private updateMspUrl =
    'https://alok-emandi-dec-20-dev-api.azurewebsites.net/crop/updateMSP';
  private getMSPUrl =
    'https://alok-emandi-dec-20-dev-api.azurewebsites.net/crop/getCropMSP';
  private addMandiUrl =
 ...
 // private baseUrl='http://localhost:8080';
  ...
  getCropPriceForBuyer(map: any): Observable<any> {
    return this.httpClient.get(
      `${'https://alok-emandi-dec-20-dev-api.azurewebsites.net/crop/getCropPrice'}` +
        `/` +
  ...
  updateCropPrice(map: any): Observable<any> {
    ...
    return this.httpClient.put(
      `${'https://alok-emandi-dec-20-dev-api.azurewebsites.net/cropVariety/updateCropPrice'}`,
      obj
    );
  }

  getFarmersByAdminIdAndMandiPincode(
    adminId: any,
    mandiPincode: any
  ): Observable<any> {
    ...
    return this.httpClient.post(
      'https://alok-emandi-dec-20-dev-api.azurewebsites.net/admin/getAllFarmersByAdminIdAndMandiPincode',
      convMap
    );
  }

  getBuyersByAdminIdAndMandiPincode(
    adminId: any,
    mandiPincode: any
  ): Observable<any> {
    const map: Map<string, string> = new Map<string, string>();
    ...
    console.log(convMap);
    return this.httpClient.post(
      'https://alok-emandi-dec-20-dev-api.azurewebsites.net/admin/getAllBuyersByAdminIdAndMandiPincode',
      convMap
    );
  }
  ...
  getQPrice(map: any): Observable<any> {
    let obj = {
      cropName: map.get('cropName'),
      cropClass: map.get('cropClass'),
      adminId: localStorage.getItem('userId'),
    };
    return this.httpClient.post(`${this.baseUrl}/admin/getQP`, obj);
  }

  updateQPrice(cropVariety: CropVariety): Observable<any> {
